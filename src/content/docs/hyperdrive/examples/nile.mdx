...
3. Click on the elephant, and you will see a connection string.
4. If you want a new pair of credentials to use with Cloudflare Hyperdrive (recommended), click **Generate credentials**.
